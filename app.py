...
# 4. ⚖️ 极速命运结算
    ...
    with st.spinner("命运结算中..."):
        ...
        请直接判断玩家的选择最符合哪一派，并结合【命运骰子判定】给出结算。
        
        【数值变动严格法则】：
        1. 【金钱】：若事件涉及花费，必须扣除大额金钱（填负数）；赚钱则加。
        2. 【心情】：满足欲望、花钱享受、骰子成功，心情大幅增加（+10到+30）；受挫、破财、骰子失败，心情大幅下降。
        3. 【努力】：只要选择迎难而上、克制欲望，即使骰子失败努力值也增加。逃避则下降。
